...
#include "../../../include/calibration_window.hpp"
...
QT_MOC_LITERAL(3, 38, 23), // "on_btnCalibrate_clicked"
QT_MOC_LITERAL(4, 62, 17) // "on_btnAdd_clicked"

    },
    "CalibrationWindow\0on_btnSave_clicked\0"
    "\0on_btnCalibrate_clicked\0on_btnAdd_clicked"
};
...
void CalibrationWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CalibrationWindow *_t = static_cast<CalibrationWindow *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_btnSave_clicked(); break;
        case 1: _t->on_btnCalibrate_clicked(); break;
...
const QMetaObject CalibrationWindow::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_CalibrationWindow.data,
      qt_meta_data_CalibrationWindow,  qt_static_metacall, nullptr, nullptr}
};
